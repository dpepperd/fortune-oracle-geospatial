...
export default function DeliverableDashboard() {
    ...
    const orthoUrl = 'https://pub-52a1995c574f4feabfe90d167713373e.r2.dev/projects/220-bridge-project/web/northbridge_map_with_scale_and_north_arrow.jpg';
    const demUrl = 'https://pub-52a1995c574f4feabfe90d167713373e.r2.dev/projects/220-bridge-project/web/northeast-section/Northbridge_DEM.jpg';

    const downloadLinks = [
        { title: 'High-Res Orthomosaic', format: 'JPG', size: '16.8 MB', icon: MapPin },
        { title: '3D Terrain Model', format: 'GLB', size: '850 MB', icon: FileBox },
        { title: 'Digital Elevation Model (DEM)', format: 'JPG', size: '12 MB', icon: Layers },
    ];
            ...
            <header className="border-b border-slate-800 bg-slate-900 px-6 py-8">
                <div className="max-w-7xl mx-auto flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div>
                        ...
                        <p className="text-slate-400 font-medium">North Bridge Section • Captured Mar 26, 2026</p>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-6 mt-10 space-y-12">
                ...
                <div>
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <span className="bg-purple-500/10 text-purple-400 border border-purple-500/20 px-3 py-1 rounded-full text-[10px] md:text-xs font-bold uppercase tracking-wider">North East Section</span>
                    </div>
                ...
                <div>
                    <div className="flex items-center gap-4 mb-6">
                        ...
                        <span className="bg-purple-500/10 text-purple-400 border border-purple-500/20 px-3 py-1 rounded-full text-[10px] md:text-xs font-bold uppercase tracking-wider whitespace-nowrap hidden sm:inline-block">North East Section</span>
                    </div>
                ...
                <div>
                    ...
                    <OrthoViewer url={demUrl} alt="220 Bridge North East DEM" />
                </div>
